/* HIP-101 — branding data (generated from Google Sheet `branding` tab).
   ...
   Colors, fonts, hero, message, heritage + signature drive the whole prototype. */
window.BRANDS = {
  generic: {
    name: "Twoja Kawiarnia", short: "Twoja Sieć", locations: 30, since: null,
    ...
    authentic: "Twój lokalny rytuał kawy i świeżych wypieków.",
    focus: "coffee", signature: { name: "Kawa dnia + rogalik", price: 18 }, sigId: "1481391319762-47dff72954d9",
    pains: [
  ...
  sowa: {
    name: "Cukiernia Sowa", short: "Sowa", locations: 170, since: "1946",
    ...
    authentic: "Cukiernicza tradycja od 1946 — torty, po które wracają pokolenia.",
    focus: "bakery", signature: { name: "Sernik Sowy", price: 15 }, sigId: "1533134242443-d4fd215305ad",
    pains: [
  ...
  putka: {
    name: "Putka", short: "Putka", locations: 100, since: "1918",
    ...
    authentic: "Rodzinna piekarnia od 1918. Zasada prosta: „nie mrozimy ciasta”.",
    focus: "bakery", signature: { name: "Chleb na zakwasie", price: 9 }, sigId: "1549931319-a545dcf3bc73",
    pains: [
  ...
  wedel: {
    name: "Pijalnie Czekolady E.Wedel", short: "E.Wedel", locations: 33, since: "1851",
    ...
    authentic: "Czekoladowa legenda od 1851 — magia słodkości w Twoim telefonie.",
    focus: "chocolate", signature: { name: "Czekolada do picia", price: 22 }, sigId: "1517578239113-b03992dcdd25",
    pains: [
  ...
  etno: {
    name: "Etno Cafe", short: "Etno", locations: 30, since: null,
    ...
    authentic: "Pierwszy w Polsce browar kawowy i rzemieślnicza palarnia.",
    focus: "coffee", signature: { name: "Wroasters Flat White", price: 16 }, sigId: "1461023058943-07fcbe16d735",
    pains: [
  ...
  oskroba: {
    name: "Piekarnia Oskroba", short: "Oskroba", locations: 200, since: "1931",
    ...
    authentic: "Chleb od 1931 — „od ziarenka do bochenka”, razowy bez drożdży.",
    focus: "bakery", signature: { name: "Chleb razowy bez drożdży", price: 11 }, sigId: "1598373182133-52452f7691ef",
    pains: [
  ...
  blikle: {
    name: "A.Blikle", short: "Blikle", locations: 25, since: "1869",
    ...
    authentic: "Warszawska cukiernia od 1869 — ręcznie zdobione dzieła sztuki.",
    focus: "bakery", signature: { name: "Pączek Blikle", price: 8 }, sigId: "1551106652-a5bcf4b29ab6",
    pains: [
  ...
  lubaszka: {
    name: "Piekarnie Lubaszka", short: "Lubaszka", locations: 30, since: null,
    ...
    authentic: "Warszawski zakwas i „MIŁOŚĆ DO CHLEBA” — świeże 3–4× dziennie.",
    focus: "bakery", signature: { name: "Chleb na zakwasie", price: 10 }, sigId: "1549931319-a545dcf3bc73",
    pains: [
  ...
  gcn: {
    name: "Green Caffè Nero", short: "GCN", locations: 40, since: "2002",
    ...
    authentic: "Premium kawa palona etycznie — „Twoja Kawa Zawsze Z Tobą”.",
    focus: "coffee", signature: { name: "Single Origin Flat White", price: 17 }, sigId: "1572442388796-11668a67e53d",
    pains: [
  ...
  grycan: {
    name: "Grycan", short: "Grycan", locations: 150, since: null,
    ...
    authentic: "Rodzinne receptury lodów przekazywane od pokoleń.",
    focus: "icecream", signature: { name: "Deser lodowy rodzinny", price: 24 }, sigId: "1497034825429-c343d7c6a68f",
    pains: [
  ...
  goraco: {
    name: "Gorąco Polecam", short: "Gorąco", locations: 100, since: null,
    ...
    authentic: "„Czysta etykieta” — zdrowy skład i tradycyjny zakwas, 100+ lokali.",
    focus: "bakery", signature: { name: "Kanapka + kawa 100% arabica", price: 21 }, sigId: "1509722747041-616f39b57569",
    pains: [
...
/* focus -> hero photo (Unsplash CDN, verified) */
window.HERO = { coffee: "1445116572660-236099ec97a0", bakery: "1509440159596-0249088772ff", chocolate: "1517578239113-b03992dcdd25", icecream: "1497034825429-c343d7c6a68f" };
